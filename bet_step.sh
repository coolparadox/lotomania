...
while true ; do
	...
	MISSING_BET_VALUES=$((BET_SIZE-HOW_MANY_BET_VALUES))
	set +e
	./comb_bet_step $MISSING_BET_VALUES $BET_VALUES_SOURCE_FILE $COMBS_GZ_SOURCE_TMP_FILE $BET_VALUES_TARGET_FILE $COMBS_GZ_TARGET_TMP_FILE
	COMB_STEP_RCODE=$?
	set -e
